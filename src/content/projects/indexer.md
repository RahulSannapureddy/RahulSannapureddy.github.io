...
# WebScout: A Custom High-Performance Search Engine
...
*   **Intelligent Web Crawler:** A Python-based BFS (Breadth-First Search) crawler designed to scrape Wikipedia. It features connection pooling, automatic resumption, and smart filtering of namespaces and duplicate content.
